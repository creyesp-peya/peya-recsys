...
SELECT
    o.order_id
  , CASE WHEN SPLIT(d.integration_code, "-")[SAFE_OFFSET(0)] IN ("D", "P") THEN LPAD(SPLIT(d.integration_code, "-")[SAFE_OFFSET(2)], 14, '0')
         WHEN SPLIT(d.integration_code, "-")[SAFE_OFFSET(0)] IN ("S", "G") THEN LPAD(SPLIT(d.integration_code, "-")[SAFE_OFFSET(3)], 14, '0')
